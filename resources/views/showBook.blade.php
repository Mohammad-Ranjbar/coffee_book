                    ...
                    <div class="card my-3">
                        <div class="card-header">
                            ...
                            @if (auth()->check() && $comment->user_id == auth()->user()->id)
                                <a href="{{route('delete-comment',['id' => $book->id])}}">
                                    <button class="btn btn-danger btn-sm float-left">حذف</button>
                                </a>
                            @endif
                ...
                <div class="col-md-4" id="select" dir="rtl">
                    <form action="{{route('cm-book',['book' => $book->id])}}" method="post" role="form" dir="rtl">
                        ...
                        <div class="form-group" dir="rtl">
                            ...
                            <textarea type="text" class="form-control" name="body" id="body" rows="8"
